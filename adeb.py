    ...
    try:
        ...
        if msg == "1":
            ...
            if d['status'] =="False": 
                ...
                data={"result":"","message":"Already accepted Ride","status":"false"}
                return data
    ...
    try:
        ...
        if msg == "1":
            ...
            if "driverId" in inputdata:
                if inputdata['driverId'] != "":
                    driverId =str(inputdata["driverId"])
                    whereCondition2=whereCondition2+" and bm.driverId= '"+ str(driverId)+"'"
            ...
            if data['result'] !="": 
                ...
                for i in data['result']:
                    ...
                    if bookingTypeId ==4 or bookingTypeId =='4':
                        columns="(dr.lat)driverLat,(dr.lng)driverLng,bm.bookingId,bm.driverId,b.dropOff,b.dropOffLatitude,b.dropOffLongitude"
                        columns=columns+",b.finalAmount,bm.pickup,bm.pickupLatitude,bm.pickupLongitude,bm.totalDistance,bm.userMobile,um.name as userName "
                        columns=columns+",dm.mobileNo as driverMobile,b.status"
                        whereCondition22=" and  dr.driverId=bm.driverId and bm.bookingId=b.bookingId  and dr.driverId=dm.driverId and bm.userId=um.userId"+whereCondition2
                        bookingDetails= databasefile.SelectQueryOrderby("bookDriver bm,bookOneMaster b,driverRideStatus dr,driverMaster as dm,userMaster as um",columns,whereCondition22,"",startlimit,endlimit,orderby)
                        print('one')
                        print(bookingDetails)
                        if bookingDetails['result'] !="":
